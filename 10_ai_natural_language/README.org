...
** Can computers learn language? (2019)
   ...
   this talk are in GitHub, and here is a [[https://github.com/birkenkrahe/ai482/blob/main/10_ai_natural_language/can_computers_learn_languages.png][screenshot]][fn:8].
