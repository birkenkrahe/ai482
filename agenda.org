...
* Week 14 - November 15 - RPA???
  ...
  * How to Make a Simple Chatbot in Under 10 Minutes (No Coding
    [Google] Dialogflow) ([[batir][Batir, 2020]]).
  * Articles: Building a chatbot assistant with IBM Watson in 30 min ([[watson][Yates,
    2021]]; [[watson][McGregor, 2021]])
  ...
  * Robotic Process Automation with UIPath (academic tutorials, [[uipath][UIPath
    2021]]).
